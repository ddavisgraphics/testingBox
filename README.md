...
## Installs
Searching the internet showcased that this library worked well for PHP as a way to manipulate audio and video fairly easily.
...
``` bash
	...
	sudo yum install ffmpeg ffmpeg-devel ffmpeg-libpostproc
```
